...
public class Dams {
	...
	public static void main(String[] args) {
		...
		System.out.println("Size of dams in Tamilanadu : " + damsInKerala.size());
		...
		System.out.println("Size of dams in AndraPradesh : " + damsInKerala.size());
		...
		System.out.println("Size of dams in Telangana : " + damsInKerala.size());
		...
		System.out.println("Size of dams in Gujarat : " + damsInGoa.size());
		...
		boolean contains1=damsInIndia .contains("Basuki Dam");
		System.out.println("contains  Basuki Dam:"+contains1);
		
		boolean contains2=damsInIndia .contains("Maha");
		System.out.println("contains Maha:"+contains2);
		...
		//remove
		boolean removed= damsInIndia.remove("Basuki Dam");
		System.out.println("removed Basuki Dam "+ removed);
		
		boolean removed1= damsInIndia.remove("maha");
		System.out.println("removed maha "+ removed1);
		
		
		//startsWith-for each and iterator
